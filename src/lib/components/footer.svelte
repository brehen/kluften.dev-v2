...
prose-h2:!text-primary-900 prose-h2:font-fancy"
		>
			...
			<div class="flex gap-4 pt-4 md:px-4 md:pt-6 prose-p:my-0">
				<img
					src={marius}
					alt="Me and Neko at ZZ Pizza in Oslo"
					class="block m-0 mb-4 max-w-[100px] rounded-md border-2 md:w-full md:h-auto bg-warning border-slate-800"
				/>
				<p class="mt-4 w-1/2">Marius likes cool tech and has three bomb ass pets.</p>
				<div>
					<div class="grid grid-cols-2 gap-4 pl-4 pt-4">
						<a
							href="https://twitter.com/mkluften"
							target="_blank"
							rel="noreferrer"
							class="bg-black p-4 rounded-full flex items-center justify-center"
							aria-label="Marius's Twitter"
						>
							<svg
						...
						<a
							href="https://github.com/brehen"
							target="_blank"
							class="bg-black p-4 rounded-full flex items-center justify-center"
							rel="noreferrer"
							aria-label="Ben's GitHub"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								class="fill-white"
