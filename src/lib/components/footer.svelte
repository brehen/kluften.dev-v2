...
<footer class="mt-auto w-screen">
	<div class="flex justify-center -mt-4">
		<div class="grid grid-cols-2 gap-4 pb-4 w-fit justify-center">
			<a
...
prose-h2:!text-primary-900 prose-h2:font-fancy"
		>
			...
			<div class="flex flex-wrap gap-4 pt-4 px-4 md:pt-6 prose-p:my-0">
				<img
					src={marius}
					alt="Me and Neko at ZZ Pizza in Oslo"
					class="block m-0 mb-4 max-w-[100px] w-1/4 rounded-md border-2 md:w-full md:h-auto bg-warning border-slate-800"
				/>
